...
public class PlayerCombat : MonoBehaviour
{
    ...
    public void moveTowardsEnemy(float moveToFactorMultiplier)
    {
        ...
        GameObject.Find("HitDetection").GetComponent<BoxCollider>().size = new Vector3(1f, 1.5f, 0.6f + (moveToFactorMultiplier * 0.6f));
    }
    ...
    public void attackEvent(string eventData)
    {
        ...
        switch (boneName)
        {
            ...
            case HitBone.WeaponMelee:
                hitLocation = playerInventory.equippedPrimary.transform.Find("WeaponImpactPoint").transform.position;
                break;
